...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/pest.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/pest.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='data/hyp.p51.yaml', help='hyperparameters path')
